...
| Rust LOC | 209230 | `wc -l` |
| Workspace tests | 4,626 listed | `cargo test --workspace -- --list` |
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 208707 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,620 listed workspace tests
