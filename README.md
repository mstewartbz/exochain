...
| Rust LOC | 210698 | `wc -l` |
| Workspace tests | 4,652 listed | `cargo test --workspace -- --list` |
...
- **4,652 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 210698 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,652 listed workspace tests
