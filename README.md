...
| Rust LOC | 342680 | `wc -l` |
| Workspace tests | 5,886 listed | `cargo test --workspace -- --list` |
...
- **5,886 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 31 crates, 342680 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 5,886 listed workspace tests
