...
| Workspace tests | 6,094 listed | `cargo test --workspace -- --list` |
...
- **6,094 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
Layer 1: CGR Kernel         (Rust, 31 crates, 374769 tracked LOC under crates/)
         ...
         SNARK/STARK/ZKML skeletons, 6,094 listed workspace tests
