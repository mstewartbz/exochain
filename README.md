...
| Rust LOC | 211213 | `wc -l` |
| Workspace tests | 4,670 listed | `cargo test --workspace -- --list` |
...
- **4,670 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 211213 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,670 listed workspace tests
