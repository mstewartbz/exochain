...
| Rust LOC | 363363 | `wc -l` |
| Workspace tests | 6,000 listed | `cargo test --workspace -- --list` |
...
- **6,000 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 31 crates, 363363 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 6,000 listed workspace tests
