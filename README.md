...
| Rust LOC | 209765 | `wc -l` |
| Workspace tests | 4,633 listed | `cargo test --workspace -- --list` |
...
- **4,633 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 209765 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,633 listed workspace tests

Layer 2: WASM Bridge        (packages/exochain-wasm/)
         164 verified bridge exports — Rust -> WebAssembly -> JavaScript
