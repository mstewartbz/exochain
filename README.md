...
| Rust LOC | 210239 | `wc -l` |
| Workspace tests | 4,637 listed | `cargo test --workspace -- --list` |
...
- **4,637 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 210239 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,637 listed workspace tests
