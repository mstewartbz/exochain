...
| Rust LOC | 372529 | `wc -l` |
| Workspace tests | 6,076 listed | `cargo test --workspace -- --list` |
...
- **6,076 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 31 crates, 372529 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         production Ed25519/BLAKE3 cryptography plus unaudited pedagogical
         SNARK/STARK/ZKML skeletons, 6,076 listed workspace tests
