...
| Rust LOC | 201868 | `wc -l` |
| Workspace tests | 4,530 listed | `cargo test --workspace -- --list` |
...
- **4,530 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 201868 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,530 listed workspace tests
