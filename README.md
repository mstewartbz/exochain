...
| Rust LOC | 111745 | `wc -l` |
| Workspace tests | 2,750 listed | `cargo test --workspace -- --list` |
...
- **2,750 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 20 crates, 111745 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 2,750 listed workspace tests
