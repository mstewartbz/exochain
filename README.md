...
| Rust LOC | 210807 | `wc -l` |
| Workspace tests | 4,656 listed | `cargo test --workspace -- --list` |
...
- **4,656 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 23 crates, 210807 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         cryptographic proofs, 4,656 listed workspace tests
