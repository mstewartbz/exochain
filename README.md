...
| Rust LOC | 371446 | `wc -l` |
| Workspace tests | 6,078 listed | `cargo test --workspace -- --list` |
...
- **6,078 workspace tests are listed** by `cargo test --workspace -- --list`; CI Gate 2 runs them in debug and release modes
...
```
Layer 1: CGR Kernel         (Rust, 31 crates, 371446 tracked LOC under crates/)
         Constitutional governance runtime — deterministic, no floats,
         production Ed25519/BLAKE3 cryptography plus unaudited pedagogical
         SNARK/STARK/ZKML skeletons, 6,078 listed workspace tests
