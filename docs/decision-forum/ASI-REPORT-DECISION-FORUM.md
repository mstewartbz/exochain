...
- **14 crates** covering identity, consent, authority, governance, escalation, legal infrastructure, cryptographic proofs, and more
- **1,089 tests. Zero failures.**
...
*The decision.forum codebase -- 29,587 lines of Rust, 14 crates, 1,089 tests, 10 formal proofs -- is available for technical review. Participation in the council process is open to qualified reviewers across all five panels.*
