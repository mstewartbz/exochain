...
EXOCHAIN is a constitutional trust fabric: 20 Rust workspace packages, 115764 lines of Rust under `crates/`, 2,868 listed tests, and a formal proof chain demonstrating its intended governance properties.
