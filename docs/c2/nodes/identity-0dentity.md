...
# Node: identity-0dentity

## Commander’s Intent (WHY)

Governed first-touch identity.

**Priority:** calibrate via daily brief / GAP row  
**Kill criteria:** Identity mint without provenance

## Dependencies

```mermaid
flowchart LR
  constitutional_core --> identity_0dentity
```

## SSOTs (progress by reference)

- Gap / decision refs: `VCG-008/009`
- Progress sources: `GAP-REGISTRY.md`
- HOW owners: `exo-identity`
...
```text
You are executing HOW under Mission C2 node identity-0dentity.
Read docs/c2/nodes/identity-0dentity.md. Obey Commander Intent and kill criteria.
