...
AVC emit/readback production-true.

**Priority:** calibrate via daily brief / GAP row  
**Kill criteria:** Trust claim without AVC evidence

## Dependencies

```mermaid
flowchart LR
  constitutional_core --> avc_root_trust
  identity_0dentity --> avc_root_trust
```

## SSOTs (progress by reference)

- Gap / decision refs: `VCG-006`
- Progress sources: `docs/avc`
- HOW owners: `exo-avc`
...
```text
You are executing HOW under Mission C2 node avc-root-trust.
Read docs/c2/nodes/avc-root-trust.md. Obey Commander Intent and kill criteria.
