...
Authenticated bridges fail closed.

**Priority:** calibrate via daily brief / GAP row  
**Kill criteria:** Unauthenticated write path

## Dependencies

```mermaid
flowchart LR
  constitutional_core --> runtime_wiring
```

## SSOTs (progress by reference)

- Gap / decision refs: `VCG-004/005/015`
- Progress sources: `INTEGRATION.md`
- HOW owners: `exo-node / exo-gateway`
...
```text
You are executing HOW under Mission C2 node runtime-wiring.
Read docs/c2/nodes/runtime-wiring.md. Obey Commander Intent and kill criteria.
