...
Wire-true CGR/ZK proof claims.

**Priority:** calibrate via daily brief / GAP row  
**Kill criteria:** Proof claim without verified backend

## Dependencies

```mermaid
flowchart LR
  constitutional_core --> proof_verification
```

## SSOTs (progress by reference)

- Gap / decision refs: `VCG-001, VCG-004`
- Progress sources: `RATIFICATION-SLATE W1`
- HOW owners: `exo-proofs`
...
```text
You are executing HOW under Mission C2 node proof-verification.
Read docs/c2/nodes/proof-verification.md. Obey Commander Intent and kill criteria.
