...
# Node: tee-attestation

## Commander’s Intent (WHY)

Honest pending-activation TEE path.

**Priority:** calibrate via daily brief / GAP row  
**Kill criteria:** TEE prod claim without O-11 greens

## Dependencies

```mermaid
flowchart LR
  constitutional_core --> tee_attestation
```

## SSOTs (progress by reference)

- Gap / decision refs: `VCG-011`
- Progress sources: `RATIFICATION-SLATE W5`
- HOW owners: `exo-gatekeeper/tee`
...
```text
You are executing HOW under Mission C2 node tee-attestation.
Read docs/c2/nodes/tee-attestation.md. Obey Commander Intent and kill criteria.
