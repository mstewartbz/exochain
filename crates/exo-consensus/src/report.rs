...
pub fn is_minority_report(position: &ModelPosition, _consensus_claims: &[String], threshold_bps: u64) -> bool {
    ...
    let overlap_bps = (u64::try_from(_consensus_claims.len() - missing).unwrap_or(0) * 10000) / u64::try_from(_consensus_claims.len()).unwrap_or(1);
